...
pub(crate) const MIN_TAB_FONT_SIZE: f32 = 8.0;
pub(crate) const MAX_TAB_FONT_SIZE: f32 = 96.0;
pub(crate) const MIN_TAB_BAR_HEIGHT: f32 = 16.0;
pub(crate) const MAX_TAB_BAR_HEIGHT: f32 = 200.0;
